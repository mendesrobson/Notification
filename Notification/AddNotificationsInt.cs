...
namespace Notification
{
    public partial class AddNotifications<T> where T : Notifiable
    {
        ...
        public AddNotifications<T> IfLowerThan(Expression<Func<T, int>> selector, int min, 
                                               string message = "")
        {
        ...
        public AddNotifications<T> IfGreaterThan(Expression<Func<T, int>> selector, int max, 
                                                 string message = "")
        {
            var val = selector.Compile().Invoke(_notifiableObject);
            var name = ((MemberExpression)selector.Body).Member.Name;
        ...
        public AddNotifications<T> IfGreaterOrEqualsThan(Expression<Func<T, int>> selector,
        ...
        public AddNotifications<T> IfLowerOrEqualsThan(Expression<Func<T, int>> selector, 
                                                       int number, string message = "")
        {
            var val = selector.Compile().Invoke(_notifiableObject);
            var name = ((MemberExpression)selector.Body).Member.Name;
        ...
        public AddNotifications<T> IfNotRange(Expression<Func<T, int>> selector, int a, 
        ...
        public AddNotifications<T> IfRange(Expression<Func<T, int>> selector, int a, 
                                           int b, string message = "")
        {
            var val = selector.Compile().Invoke(_notifiableObject);
            var name = ((MemberExpression)selector.Body).Member.Name;
        ...
        public AddNotifications<T> IfNotAreEquals(Expression<Func<T, int>> selector, 
        ...
        public AddNotifications<T> IfAreEquals(Expression<Func<T, int>> selector, 
                                               int value, string message = "")
        {
            var val = selector.Compile().Invoke(_notifiableObject);
            var name = ((MemberExpression)selector.Body).Member.Name;
        ...
        /// <param name="message">Mensagem de erro (Opcional)</param>
        /// <returns>Dado um int, adicione uma notificação se for maior ou igual ao parametro passado</returns>
        public AddNotifications<T> IfGreaterOrEqualsThan(int val, int number, string objectName,
                                                         string message = "")
        {
            if (val >= number)
                _notifiableObject.AddNotification(objectName, string.IsNullOrEmpty(message) ? 
        ...
        /// <param name="message">Mensagem de erro (Opcional)</param>
        /// <returns>Dado um int, adicione uma notificação se for menor ou igual ao parametro passado</returns>
        public AddNotifications<T> IfLowerOrEqualsThan(int val, int number, string objectName, 
                                                       string message = "")
        {
            if (val <= number)
                _notifiableObject.AddNotification(objectName, string.IsNullOrEmpty(message) ? 
