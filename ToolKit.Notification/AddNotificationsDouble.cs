...
namespace Notification
{
    public partial class AddNotifications<T> where T : Notifiable
    {
        ...
        public AddNotifications<T> IfLowerThan(Expression<Func<T, double>> selector, double min, 
                                               string message = "")
        {
            var val = selector.Compile().Invoke(_notifiableObject);
            var name = ((MemberExpression)selector.Body).Member.Name;
        ...
        public AddNotifications<T> IfGreaterThan(Expression<Func<T, double>> selector, 
        ...
        public AddNotifications<T> IfGreaterOrEqualsThan(Expression<Func<T, double>> selector, 
        ...
        public AddNotifications<T> IfLowerOrEqualsThan(Expression<Func<T, double>> selector, 
                                                       double number, string message = "")
        {
            var val = selector.Compile().Invoke(_notifiableObject);
            var name = ((MemberExpression)selector.Body).Member.Name;
        ...
        public AddNotifications<T> IfNotRange(Expression<Func<T, double>> selector, 
                                              double a, double b, string message = "")
        {
            var val = selector.Compile().Invoke(_notifiableObject);
            var name = ((MemberExpression)selector.Body).Member.Name;
        ...
        public AddNotifications<T> IfRange(Expression<Func<T, double>> selector, 
                                           double a, double b, string message = "")
        {
            var val = selector.Compile().Invoke(_notifiableObject);
            var name = ((MemberExpression)selector.Body).Member.Name;
        ...
        public AddNotifications<T> IfNotAreEquals(Expression<Func<T, double>> selector, 
        ...
        public AddNotifications<T> IfAreEquals(Expression<Func<T, double>> selector, 
                                               double value, string message = "")
        {
            var val = selector.Compile().Invoke(_notifiableObject);
            var name = ((MemberExpression)selector.Body).Member.Name;
        ...
        /// <param name="message">Mensagem de erro (Opcional)</param>
        /// <returns>Dado um int, adicione uma notificação se for maior ou igual ao parametro passado</returns>
        public AddNotifications<T> IfGreaterOrEqualsThan(double val, double number, string objectName, 
                                                         string message = "")
        {
            if (val >= number)
                _notifiableObject.AddNotification(objectName, string.IsNullOrEmpty(message) ? 
        ...
        /// <param name="message">Mensagem de erro (Opcional)</param>
        /// <returns>Dado um int, adicione uma notificação se for menor ou igual ao parametro passado</returns>
        public AddNotifications<T> IfLowerOrEqualsThan(double val, double number, string objectName, 
                                                       string message = "")
        {
            if (val <= number)
                _notifiableObject.AddNotification(objectName, string.IsNullOrEmpty(message) ? 
        ...
        /// <param name="message">Mensagem de erro (Opcional)</param>
        /// <returns>Dado um int, adicione uma notificação se não estiver entre alguns dois valores</returns>
        public AddNotifications<T> IfNotRange(double val, double a, double b, string objectName, 
                                              string message = "")
        {
            if (val < a || val > b)
                _notifiableObject.AddNotification(objectName, string.IsNullOrEmpty(message) ? 
        ...
        /// <param name="message">Mensagem de erro (Opcional)</param>
        /// <returns>Dado um int, adicione uma notificação se estiver entre alguns dois valores</returns>
        public AddNotifications<T> IfRange(double val, double a, double b, string objectName, 
                                           string message = "")
        {
            if (val > a && val < b)
                _notifiableObject.AddNotification(objectName, string.IsNullOrEmpty(message) ? 
        ...
        /// <param name="message">Mensagem de erro (Opcional)</param>
        /// <returns>Dada uma string, adicione uma notificação se não for igual a</returns>
        public AddNotifications<T> IfNotAreEquals(double val, double value, string objectName, 
                                                  string message = "")
        {
            if (val != value)
                _notifiableObject.AddNotification(objectName, string.IsNullOrEmpty(message) ? 
        ...
        /// <param name="message">Mensagem de erro (Opcional)</param>
        /// <returns>Dada uma string, adicione uma notificação se for igual a</returns>
        public AddNotifications<T> IfAreEquals(double val, double value, string objectName, 
                                               string message = "")
        {
            if (val == value)
                _notifiableObject.AddNotification(objectName, string.IsNullOrEmpty(message) ? 
